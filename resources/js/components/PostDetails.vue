...
<template>
    <section class="w-11/12 py-40 mx-auto 2xl:w-8/12 lg:w-10/12">
        ...
        <div class="flex flex-col gap-3 mt-10">
            ...
            <h1 class="font-[200] text-accent1 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px]">{{ title }}</h1>
            <h3 class="text-accent2 font-[200] max-sm:text-[14px]">{{ date }}</h3>
            <p class="tracking-wide text-accent2 font-[200] max-sm:text-[14px] text-justify mb-6">{{ body }}</p>
        </div>
    </section>
</template>