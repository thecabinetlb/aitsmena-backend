...
class BlogPostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $blogPosts = [
            [
                'id' => 1,
                'thumbnail' => url('/blog/thumbnails/two-colleagues-factory.webp'),
            ...
            [
                'id' => 2,
                'thumbnail' => url('/blog/thumbnails/aerial-shot-downtown-los-angeles-night.webp'),
            ...
            [
                'id' => 3,
                'thumbnail' => url('/blog/thumbnails/experienced-operator-hard-hat.webp'),
            ...
            [
                'id' => 4,
                'thumbnail' => url('/blog/thumbnails/top-view-modern-operational-plant-producing-fiberglass-heavy-industry-machinery-metalworking-workshop-concept.webp'),
            ...
            [
                'id' => 5,
                'thumbnail' => url('/blog/thumbnails/woman-engineer-posing-with-workers-metalworking-factory.webp'),
            ...
            [
                'id' => 6,
                'thumbnail' => url('/blog/thumbnails/two-women-medical-suits-working-conveyor.webp'),
            ...
            [
                'id' => 7,
                'thumbnail' => url('/blog/thumbnails/abandoned-textile-factory-soviet-armenia.webp'),
